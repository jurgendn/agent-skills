...
Inspect where the method wins and fails (slices, failure categories), then turn the runs into a clear results narrative. Use `failure-taxonomist` / `statistical-testing-guide` when relevant.
