...
- The user wants SOP drafting. Use `sop-writer`.
- The user wants detailed CV rewriting. Use `academic-cv-builder`.
- The user wants full application coherence review. Use `phd-application-package-auditor`.
