---
name: phd-application-package-auditor
...
- The user wants to write or line-edit a Statement of Purpose. Use `sop-writer`.
- The user wants to build or rewrite an academic CV. Use `academic-cv-builder`.
- The user wants to choose faculty or programs from scratch. Use `phd-program-fit-mapper`.
- The user wants recommender emails or letter strategy only. Use `recommendation-letter-strategist`.
