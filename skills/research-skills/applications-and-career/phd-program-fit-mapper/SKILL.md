...
- The user wants to write the SOP itself. Use `sop-writer`.
- The user wants a broad literature review not tied to application fit. Use `literature-triangulation`.
- The user wants to audit a finished application package. Use `phd-application-package-auditor`.
- The user wants CV structure or bullet rewriting. Use `academic-cv-builder`.
...
Do not write polished SOP paragraphs unless the user asks; hand off to `sop-writer` for prose drafting.
