---
name: professor-cold-email-drafter
...
- The user has not yet figured out what the professor currently works on. Use `professor-research-direction-mapper` first.
- The user wants a full SOP or application essay. Use `sop-writer`.
- The user is comparing many faculty or programs. Use `phd-program-fit-mapper`.
- The user needs recommender strategy. Use `recommendation-letter-strategist`.
