...
- The user wants to write or revise a Statement of Purpose. Use `sop-writer`.
- The user wants faculty or program matching. Use `phd-program-fit-mapper`.
- The user wants a full application-package risk audit. Use `phd-application-package-auditor`.
