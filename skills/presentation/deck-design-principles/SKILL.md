...
- `deck-beamer-academic` — seminar, conference, lecture (LaTeX Beamer)
- `deck-beamer-proposal-report` — proposal, progress/final report (LaTeX Beamer)
- `deck-business-report` — industrial / executive report (PowerPoint via python-pptx, or Canva)
